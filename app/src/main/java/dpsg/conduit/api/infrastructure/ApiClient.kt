package dpsg.conduit.api.infrastructure
...
import dpsg.conduit.api.infrastructure.PartConfig
import dpsg.conduit.api.infrastructure.RequestConfig
import dpsg.conduit.api.infrastructure.RequestMethod
import dpsg.conduit.api.infrastructure.Serializer
import dpsg.conduit.api.infrastructure.isClientError
import dpsg.conduit.api.infrastructure.isInformational
...
open class ApiClient(val baseUrl: String, val client: OkHttpClient = defaultClient) {
    companion object {
        ...
        const val baseUrlKey = "dpsg.conduit.api.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            ...
            val tempFile = java.nio.file.Files.createTempFile("tmp.dpsg.conduit.api", null).toFile()
